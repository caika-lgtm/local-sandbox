...
- 2026-07-04: Green M05 smoke run `28697374629` produced `boot.status.json` with `observed_alive` and redacted argv with `-cpu Westmere`. Its `serial.log` existed but was empty; this milestone still does not prove guest serial progress or readiness.
